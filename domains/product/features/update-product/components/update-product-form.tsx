...
export function UpdateProductForm({ product }: UpdateProductFormProps) {
	...
	const form = useAppForm({
		defaultValues: {
			...
			weight: state?.inputs?.weight as number | null,
			width: state?.inputs?.width as number | null,
			height: state?.inputs?.height as number | null,
			depth: state?.inputs?.depth as number | null,
