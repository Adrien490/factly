	...
	return (
		...
		>
			...
			<div className="absolute inset-0 opacity-0 group-hover/feature:opacity-100 transition-opacity duration-700 pointer-events-none overflow-hidden">
				<div
					className="absolute w-1.5 h-1.5 rounded-full bg-primary/40 top-1/4 left-1/5 blur-sm animate-pulse"
					style={{ animationDuration: "3s", animationDelay: "0.2s" }}
				></div>
				<div
					className="absolute w-2 h-2 rounded-full bg-primary/30 bottom-1/4 right-1/5 blur-sm animate-pulse"
					style={{ animationDuration: "4s", animationDelay: "0.5s" }}
				></div>
				<div
					className="absolute w-1 h-1 rounded-full bg-primary/50 top-2/3 left-2/5 blur-sm animate-pulse"
			...
			<div className="p-7 md:p-8 relative z-10 h-full flex flex-col">
				...
				<div className="space-y-5 mb-5">
					...
					<div className="text-primary transition-transform duration-300 group-hover/feature:translate-y-[-2px]">
						<div className="w-14 h-14 flex items-center justify-center bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl border border-primary/20 shadow-sm group-hover/feature:shadow-md transition-all duration-300 relative overflow-hidden">
							{/* Effet lumineux sur l'icône */}
							<div className="absolute inset-0 opacity-0 group-hover/feature:opacity-100 transition-opacity duration-500 bg-gradient-to-r from-primary/0 via-primary/10 to-primary/0 blur-sm"></div>
					...
					<div className="relative">
						<div className="absolute left-0 -ml-6 top-1/2 -translate-y-1/2 h-6 group-hover/feature:h-full w-[3px] rounded-r-full bg-gradient-to-b from-primary/50 to-primary/30 transition-all duration-300 origin-top opacity-0 group-hover/feature:opacity-100 shadow-[0_0_8px_rgba(var(--primary-rgb),0.3)]" />
				...
				<p className="text-sm md:text-base text-muted-foreground/80 mb-6 leading-relaxed flex-grow transition-all duration-300 group-hover/feature:text-muted-foreground/95 group-hover/feature:translate-y-[-2px]">
					{description}
				</p>
				...
				{benefits && benefits.length > 0 && (
					<div className="mt-auto space-y-3.5">
						{benefits.map((benefit, i) => (
							...
							>
								<div
									className="flex-shrink-0 w-5 h-5 flex items-center justify-center bg-primary/10 rounded-full text-primary transition-all duration-300 group-hover/feature:bg-primary/20 group-hover/feature:scale-110"
			...
			<div className="absolute inset-0 opacity-0 group-hover/feature:opacity-30 -z-10 transition-opacity duration-500 pointer-events-none bg-gradient-to-tr from-primary/10 via-transparent to-transparent" />

			{/* Effet de lueur en bas - style neomorphique 2025 */}
			<div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3/4 h-[2px] opacity-0 group-hover/feature:opacity-100 transition-opacity duration-700 bg-gradient-to-r from-primary/0 via-primary/30 to-primary/0 blur-sm"></div>
		</motion.div>
	);
}
