...
import deleteOrganizationFormSchema from "../../../../(with-sidebar)/organizations/schemas/delete-organization-form-schema";
import deleteOrganization from "../../../../(with-sidebar)/organizations/server/delete-organization";
...
export default function DeleteOrganizationForm({
	...
	>(
		...
		{ status: ServerActionStatus.IDLE, message: "" }
	);
